const translations = {
  zh: {
    ...
    heroTitle: "一套拧紧单元，<br>覆盖多规格、<br>多工位生产", heroLead: "自动切换多工位套筒、工业机器人与拧紧轴组成柔性拧紧单元。", viewProducts: "查看核心产品", principlesAria: "方案原则", principleOne: "自动换型", principleTwo: "多点覆盖", principleThree: "过程可控",
    heroFrameAria: "自动换套筒机器人全流程演示", heroFrameLabel: "实机演示 · 自动换套筒与机器人协同", heroFrameCaption: "真实设备演示：机器人取放套筒并完成自动切换。", fullProcessVideoAria: "自动换套筒与机器人协同全流程视频", componentBoardAria: "柔性拧紧单元组成", videoFallback: "您的浏览器暂不支持视频播放。",
    sectionNavAria: "页面章节", pageIndex: "页面索引", indexChallenges: "生产难点", indexArchitecture: "整线架构", indexWorkflow: "工作流程", indexProducts: "核心产品", indexDelivery: "项目交付",
    ...
    productsTitle: "三类核心产品", productsLead: "已接入产品实拍与演示视频，具体型号和参数待资料确认后补充。", productImagePlaceholder: "产品视觉占位", socketMediaLabel: "实拍与单机演示", productPhotoLabel: "产品图", socketVideoAria: "单套筒自动切换展示视频", singleUnitDemo: "单套筒切换演示", socketDetailPhoto: "切换机构细节", socketAssemblyPhoto: "多工位套筒站", robotMediaNote: "工业机器人本体；型号与工作半径参数待补充。", spindleMediaNote: "拧紧轴本体；型号、扭矩范围与曲线界面待补充。",
  ...
  en: {
    ...
    heroTitle: "One tightening cell<br>for multiple fastener types<br>and stations", heroLead: "An automatic socket changer, industrial robot, and tightening spindle form one flexible cell.", viewProducts: "View core products", principlesAria: "Solution principles", principleOne: "Automatic changeover", principleTwo: "Multi-point reach", principleThree: "Controlled process",
    heroFrameAria: "Full robot and automatic socket-change demonstration", heroFrameLabel: "Live demo · Robot and automatic socket changing", heroFrameCaption: "Real equipment demonstration: the robot picks, places, and changes sockets automatically.", fullProcessVideoAria: "Full robot and automatic socket-change process video", componentBoardAria: "Flexible tightening cell components", videoFallback: "Your browser does not support video playback.",
    sectionNavAria: "Page sections", pageIndex: "Page index", indexChallenges: "Challenges", indexArchitecture: "Architecture", indexWorkflow: "Workflow", indexProducts: "Core products", indexDelivery: "Delivery",
    ...
    productsTitle: "Three core products", productsLead: "Product photography and demonstrations are now included; exact models and specifications will follow.", productImagePlaceholder: "Product visual placeholder", socketMediaLabel: "Photography and unit demo", productPhotoLabel: "Product image", socketVideoAria: "Single-unit automatic socket-change demonstration", singleUnitDemo: "Single-unit change demo", socketDetailPhoto: "Changer mechanism detail", socketAssemblyPhoto: "Multi-station socket rack", robotMediaNote: "Industrial robot shown; model and working-envelope data to follow.", spindleMediaNote: "Tightening spindle shown; model, torque range, and curve UI to follow.",
